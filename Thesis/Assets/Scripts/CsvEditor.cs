...
public class CsvEditor 
{
    ...
    public static void CSVtoReplayObject(string[] lines)
    {
        ...
        ReplayObject replayObject = new ReplayObject("deneme", replayInfos);
        string json = JsonConvert.SerializeObject(replayObject.replayInfo.ToArray(), Formatting.Indented);

        //write string to file
        System.IO.File.WriteAllText(string.Concat(@"C:\StudentProjects\Burakhan\Tesla Suit\Assets\JsonAttempts\\", $"{replayObject.animationName}", ".json"), json);
    }
